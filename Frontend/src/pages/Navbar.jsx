...
export default function Navbar({ onSync }) {
    ...
    return (
        <nav className="relative z-50 px-6 py-5 border-b border-gray-900/5 bg-transparent">
                ...
                <div className="flex justify-between w-full h-12 items-center">
                    ...
                    <div className="flex items-center gap-5">
                        ...
                        <button
                            ...
                            className="flex items-center gap-1 text-sm font-bold text-red-600 bg-red-50 border border-red-100 hover:bg-red-500 hover:text-white px-4 py-2 rounded-xl transition-all ml-2 shadow-sm"
                        >
                            Log out
                        </button>
                    </div>
